...
// added by chenfei
void my_read_inode(int fd, off_t start_inode_table, int inode_no, struct ext2_inode *inode);

/* added by chenfei: read a data block for an inode */
